...
更新时间：2026-09-05  
状态：Wells Fargo、Accenture 已完成生产字段回填与严格回归；MongoDB、Okta、Elastic、Duolingo、Roblox、Jane Street 六家 Greenhouse 公司已于 2026-09-05 完成生产回填与验收；BlackRock 已于同日完成官方详情接入与生产回填；按来源族逐批执行，不做全站批量回填
...
| 来源族 | 已确认公司 | 当前处理方式 |
| --- | --- | --- |
| Greenhouse | Cloudflare、Stripe、Datadog、Coinbase、Asana、Brex、Databricks、Figma、GitLab、Point72、Reddit、Robinhood、Twilio、Discord、TPG、Bridgewater Associates、General Atlantic、MongoDB、Okta、Elastic、Duolingo、Roblox、Jane Street | `src/lib/job-connectors/greenhouse.ts` + 详情页补充 |
