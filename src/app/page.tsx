...
export default function Home() {
  return (
    <AuroraBackground className="h-auto min-h-screen">
      ...
      <nav className="sticky top-0 z-50 border-b border-white/20 bg-slate-900/60 backdrop-blur-2xl">
        <div className="container mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 md:gap-3 group">
            ...
            <span className="font-bold text-lg md:text-xl bg-gradient-to-r from-cyan-400 via-blue-400 to-indigo-400 bg-clip-text text-transparent">Rising Path</span>
          </Link>
          
          {/* Desktop Nav */}
          <div className="hidden md:flex items-center gap-2">
            <Link href="/jobs">
              <Button variant="ghost" size="sm" className="text-white/90 hover:text-white hover:bg-white/10 transition-all">
                岗位开放
              </Button>
            </Link>
      ...
      <section className="container mx-auto px-4 md:px-6 pt-16 pb-16 md:pt-28 md:pb-24">
        ...
        >
          {/* Badge - Glass Effect */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-800/60 backdrop-blur-2xl border border-white/20 mb-8">
      ...
      <section className="container mx-auto px-4 md:px-6 mb-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
          {advantages.map((adv, index) => (
            <div key={adv.title} className="group relative overflow-hidden rounded-2xl bg-slate-800/60 backdrop-blur-2xl border border-white/20 p-6 md:p-8 hover:bg-slate-700/70 transition-all duration-300 hover:-translate-y-1">
      ...
      <section id="features" className="container mx-auto px-4 md:px-6 py-12 md:py-24">
        <div className="text-center mb-12 md:mb-20">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-800/60 backdrop-blur-2xl border border-white/20 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {features.map((feature) => (
            ...
            >
              {/* Glass Background */}
              <div className="absolute inset-0 bg-slate-800/60 backdrop-blur-2xl border border-white/20 rounded-2xl md:rounded-3xl" />
      ...
      <section className="container mx-auto px-4 md:px-6 py-12 md:py-20">
        <div className="relative rounded-3xl bg-slate-800/60 backdrop-blur-2xl border border-white/20 p-8 md:p-12 lg:p-16 overflow-hidden">
          {/* Decorative elements */}
