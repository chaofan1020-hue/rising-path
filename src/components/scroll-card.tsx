  ...
  return (
    ...
    >
      <div className="relative p-6 md:p-12 rounded-2xl md:rounded-[32px] bg-neutral-950 text-white overflow-hidden hover:-translate-y-1 md:hover:-translate-y-3 transition-all duration-500">
        <div className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 ${iconColor === 'text-sky-600' ? 'bg-gradient-to-br from-terracotta-500/30 via-terracotta-600/10 to-transparent' : iconColor === 'text-violet-600' ? 'bg-gradient-to-br from-sage-500/30 via-sage-600/10 to-transparent' : 'bg-gradient-to-br from-beige-500/30 via-beige-600/10 to-transparent'}`} />
        ...
        <div className={`absolute bottom-0 left-0 right-0 h-px ${iconColor === 'text-sky-600' ? 'bg-gradient-to-r from-transparent via-terracotta-400 to-transparent' : iconColor === 'text-violet-600' ? 'bg-gradient-to-r from-transparent via-sage-400 to-transparent' : 'bg-gradient-to-r from-transparent via-beige-400 to-transparent'} opacity-50 group-hover:opacity-100 transition-opacity duration-300`} />
      </div>
    </div>
  );
}
