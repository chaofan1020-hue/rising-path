...
const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "about.words": "服务用户",
    "about.brands": "合作企业",
    "about.higherEngagement": "成功率",
    "about.title": "让每一个求职者都能找到自己的上升之路",
    "about.p1": "我们的旅程始于对求职行业的深刻理解，我们相信每个人都应该有机会获得高质量的求职服务，而不仅仅是那些负担得起昂贵费用的人。",
    "about.p2": "每一个求职者都有自己的故事，我们专注于用清晰和有力的方式讲述你的故事，帮助你在求职市场中脱颖而出。",
    "about.brandName": "RISING PATH",
    "about.brandTitle": "求职平台 | 职业发展伙伴",
    "about.ctaText": "准备好开启你的上升之路了吗？",
  ...
  "zh-TW": {
    ...
    // About Section
    "about.whoIAm": "關於我們",
    "about.yearsExperience": "年經驗",
    "about.words": "服務用戶",
    "about.brands": "合作企業",
    "about.higherEngagement": "成功率",
    "about.title": "讓每一個求職者都能找到自己的上升之路",
    "about.p1": "我們的旅程始於對求職行業的深刻理解，我們相信每個人都應該有機會獲得高質量的求職服務，而不僅僅是那些負擔得起昂貴費用的人。",
    "about.p2": "每一個求職者都有自己的故事，我們專注於用清晰和有力的方式講述你的故事，幫助你在求職市場中脫穎而出。",
    "about.brandName": "RISING PATH",
    "about.brandTitle": "求職平台 | 職業發展夥伴",
    "about.ctaText": "準備好開啟你的上升之路了嗎？",
    "about.ctaButton": "立即開始",
    // 功能頁面
  ...
  "en": {
    ...
    // About Section
    "about.whoIAm": "WHO WE ARE",
    "about.yearsExperience": "years of experience",
    "about.words": "users served",
    "about.brands": "partner companies",
    "about.higherEngagement": "success rate",
    "about.title": "Helping every job seeker find their path to success",
    "about.p1": "Our journey began with a deep understanding of the job search industry. We believe everyone should have access to high-quality career services, not just those who can afford expensive fees.",
    "about.p2": "Every job seeker has a story, and we specialize in telling yours with clarity and impact, helping you stand out in the job market.",
    "about.brandName": "RISING PATH",
    "about.brandTitle": "Career Platform | Career Development Partner",
    "about.ctaText": "Ready to start your journey to success?",
